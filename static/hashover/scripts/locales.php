<?php
	...
	$locale = array(
		...
		'fr' => array(
			...
			'logged_in'	=> 'Vous êtes authentifié avec succès !',
			...
			'subscribe'	=> 'Souscrire',
			'edit_cmt'	=> 'Éditer le commentaire',
			'save_edit'	=> 'Enregistrer les modification',
			'no_email_warn'	=> 'Vous ne recevrez pas de notification des réponses sans fournir un email.',
			'delete_cmt'	=> 'Vous êtes sûr de vouloir supprimer ce commentaire ?',
			'post_cmt'	=> 'Poster un commentaire',
			'popular_cmts'	=> 'Les plus populaires',
			'showing_cmts'	=> 'Afficher',
			'sort'		=> 'Trier',
			'sort_ascend'	=> 'Dans l&apos;ordre',
			'sort_descend'	=> 'Dans l&apos;ordre inverse',
			'sort_byname'	=> 'Par commentateur',
			'sort_bydate'	=> 'Par date (le plus récent en premier)',
			'sort_bylikes'	=> 'Par like',
			'thread'	=> 'Haut du fil',
			'thread_tip'	=> 'Aller en haut du fil',
			'like_cmt'	=> '\'Like\' ce commentaire',
			'liked_cmt'	=> 'Vous avez liké ce commentaire',
			'op_cmt_note'	=> 'Vous ne serez pas notifié par email',
			'subbed_note'	=> 'Notifié par email',
			'unsubbed_note' => 'n&apos;est pas souscrit à la notification par email'
		),
