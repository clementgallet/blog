<?php
	...
	$language	= 'fr';						// Language used for forms, buttons, links, and tooltips
	$name		= 'Anonyme';				// Nickname when one isn't given
	$template	= 'ghostscript';					// Comment layout template
	...
	$spam_IP_check	= 'javascript';					// Options 'javascript' / 'php' for respective modes, or 'both'
